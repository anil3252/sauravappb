...
public class Office extends AppCompatActivity {
    ...
    Spinner inputPanchayatSamiti ,inputGPName ,inputVisitDept,inputOfficeClean,inputListEmp,inputSlip,inputAvilityOffice,inputSpace,inputStayEmp;
    EditText inputVillageName,inputOfficeName,inputTotalEmp,inputWithOutinfoEmp,inputAcsentEmp,inputdiscription ;
    Button btnRegister;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_officeins);
...
//        }
    ...
    public void addListenerOnSpinnerItemSelection() {
        ...
        fillarray();
        inputPanchayatSamiti.setAdapter(new ArrayAdapter<String>(Office.this,
                android.R.layout.simple_dropdown_item_1line, pslist));
        inputVisitDept.setAdapter(new ArrayAdapter<String>(Office.this,
                android.R.layout.simple_dropdown_item_1line, vibhag));
        inputOfficeClean.setAdapter(new ArrayAdapter<String>(Office.this,
                android.R.layout.simple_dropdown_item_1line, officeclean));
        inputListEmp.setAdapter(new ArrayAdapter<String>(Office.this,
                android.R.layout.simple_dropdown_item_1line, emplist));
        inputSlip.setAdapter(new ArrayAdapter<String>(Office.this,
                android.R.layout.simple_dropdown_item_1line, slip));
        inputAvilityOffice.setAdapter(new ArrayAdapter<String>(Office.this,
...
//                android.R.layout.simple_dropdown_item_1line, space));
        inputStayEmp.setAdapter(new ArrayAdapter<String>(Office.this,
                android.R.layout.simple_dropdown_item_1line, stay));

        inputVisitDept.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1, int pos,
                ...
                if(pos==8 || pos ==9) {
                    inputSpace.setAdapter(new ArrayAdapter<String>(
                            Office.this,
                            android.R.layout.simple_dropdown_item_1line, spaceelem));
                }else
                {
                    inputSpace.setAdapter(new ArrayAdapter<String>(
                            Office.this,
            ...
            public void onClick(View view) {
                ...
                if (( !inputVillageName.getText().toString().equals(""))&&( !inputPanchayatSamiti.getSelectedItem().toString().equals("---चयन करे---")) &&( !inputGPName.getSelectedItem().toString().equals("---चयन करे---")) && (!FilePath.equals("")) )
                {
                    if ( !inputVillageName.getText().toString().equals("") ){
                        ...
                        building = inputAvilityOffice.getSelectedItem().toString();
                        space = inputSpace.getSelectedItem().toString();
                        stay= inputStayEmp.getSelectedItem().toString();
    ...
    private void fillarray() {
        ...
        officeclean.add("उत्कृष्ट");
        officeclean.add("संतोषजनक");
        officeclean.add("असंतोषजनक");
                ...
                builder.setMessage(message).setTitle("Response from Servers")
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                Intent upanel = new Intent(Office.this, Office.class);
