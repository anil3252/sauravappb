...
public class Mdm extends AppCompatActivity
{
    ...
    public void back(View v) {
        Intent i_back=new Intent(Mdm.this,MainActivity.class);
    ...
    public void addListenerOnSpinnerItemSelection() {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (( !inputVillageName.getText().toString().equals("")) && ( !inputWorkName.getText().toString().equals(""))&& !inputVisitDept.getSelectedItem().equals("---चयन करे---")&&( !inputPanchayatSamiti.getSelectedItem().toString().equals("---चयन करे---")) &&( !inputGPName.getSelectedItem().toString().equals("---चयन करे---")) && (!FilePath.equals("")))
                {
            ...
            public void onClick(View view) {
                if ((!inputVillageName.getText().toString().equals("")) && (!inputWorkName.getText().toString().equals("")) && !inputVisitDept.getSelectedItem().equals("---चयन करे---") && (!inputPanchayatSamiti.getSelectedItem().toString().equals("---चयन करे---")) && (!inputGPName.getSelectedItem().toString().equals("---चयन करे---")) && (!FilePath.equals(""))) {
                    if (!inputVillageName.getText().toString().equals("")) {
                        ...
                        db.close();
                        SaveOnLocalDB(PSname, GPName, Village, InsepectionDept, Oname, LoginMobile, Wtype, WSituation, Mfood, Mclean, Mkitchen, Mgrade, FilePath, lati, longi, accur);
                    } else {
                        Toast.makeText(getApplicationContext(),
                                "Username should be minimum 5 characters", Toast.LENGTH_SHORT).show();
                    }
        ...
        fillarray();
        inputPanchayatSamiti.setAdapter(new ArrayAdapter<String>(Mdm.this,
                android.R.layout.simple_dropdown_item_1line, pslist));
        inputVisitDept.setAdapter(new ArrayAdapter<String>(Mdm.this,
                android.R.layout.simple_dropdown_item_1line, vibhag));
        inputPosition.setAdapter(new ArrayAdapter<String>(Mdm.this,
                android.R.layout.simple_dropdown_item_1line, postionwork));
        inputFood.setAdapter(new ArrayAdapter<String>(Mdm.this,
                android.R.layout.simple_dropdown_item_1line, afood));
        inputPlace.setAdapter(new ArrayAdapter<String>(Mdm.this,
                android.R.layout.simple_dropdown_item_1line, aplace));
        inputKitchen.setAdapter(new ArrayAdapter<String>(Mdm.this,
    ...
    public void SaveOnLocalDB(String PSname, String GPName,String  Village,String  InsepectionDept,String  Oname,String  LoginMobile,String  Wtype,String  WSituation,String  Mfood,String  Mclean,String  Mkitchen,String  Mgrade,String  FilePath,String  lati,String  longi,String  accur) {
        SQLiteDatabase db;
        db = openOrCreateDatabase("NumDB", Context.MODE_PRIVATE, null);
        ...
        Cursor c = db.rawQuery("SELECT * FROM MDM ", null);
        if (c.getCount() < 3)
        {
            db.execSQL("INSERT INTO MDM VALUES('" + PSname + "','" + GPName + "','" + Village + "','" + InsepectionDept + "','" + Oname + "','" + LoginMobile + "','" + Wtype + "','" + WSituation + "','" + Mfood + "','" + Mclean + "','" + Mkitchen + "','" + Mgrade + "','" + FilePath + "','" + lati + "','" + longi + "','" + accur + "');");
            Intent upanel = new Intent(Mdm.this, Mdm.class);
    ...
    private void insertToDatabase(String name, String add,String village ,String inspectdep ,String ofname,String mob,String typeW ,String SituW, String Mfood ,String Mclean, String Mkitchen,String Mgrade, String FilePath,String lat,String longi,String accur ){
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                nameValuePairs.add(new BasicNameValuePair("fpath", paramFilePath));
